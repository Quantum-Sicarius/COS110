...
/*
   ...
   characters. The int parameter specifies the matrix side (width, height). Since matrix is a
   2D structure, a 2D array of char type is dynamically allocated and returned. Characters
   are not initialized – this function simply creates an empty structure and returns it.
 */
